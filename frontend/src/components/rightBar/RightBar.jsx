      ...
      <div className="container">
        <div className="item">
          ...
          <div className="user">
            <div className="userInfo">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyq5UVsMrLsOhWXyjEBxVBRMHrOgyXJYw02w&s"
                alt=""
              />
              <span>Clendra Fonseka</span>
            </div>
            <div className="buttons">
              <button>Follow</button>
              <button>Dismiss</button>
        ...
        <div className="item">
          ...
          <div className="user">
            <div className="userInfo">
              ...
              />
              <p>
                <span>Clendra Fonseka</span> Chanded their cover photo
              </p>
            </div>
